...
<section className={`${styles.paddings} relative z-10`}>
    <motion.div
      ...
      // When you specify a size, ie. sm md lg, the same type of option that
      // is included without the indentifier is what will happen 'usually'.
    ...
    >
      ...
      >
        ...
        <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px]
          ...
          today's work, or can be called web 3.0 by using metaverse you can use it
          as anything."
        </p>
      </motion.div>
      <motion.div
