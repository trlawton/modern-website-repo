...
import { motion } from "freamer-motion";
import styles from "../styles";
import { fadeIn } from "../utils/motion";

// All these props are the props that the ExploreCards takes in -- index, active,
// handleClick, and the world object contains -- id, imgURL, title,
